"""Static policy tests for assets/Dockerfile (no Docker needed)."""
...
def test_multi_stage_build_copies_artifacts_from_an_earlier_stage(dockerfile):
...
def test_start_command_uses_exec_form_so_sigterm_reaches_the_app(dockerfile):
